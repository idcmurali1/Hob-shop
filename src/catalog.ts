...
export const CATALOG: Product[] = [
  { 
    ...
    testID: 'product_sku_hoodie_8777'      // 👈 unique testID
  },
  { 
    id: 'sku_cap', 
    title: 'HOB Dad Cap', 
  ...
  { 
    ...
    testID: 'product_sku_shirt_val222' 
  },
  { 
    id: 'sku_headphones', 
